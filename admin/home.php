        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a href="gownbook.php"><i class="fa fa-bar-chart-o"></i> Gown Hiring</a>
                    </li>
                    <li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Status <small>Gown Hiring</small>
                        </h1>
                    </div>
                </div>
                <!-- /. ROW  -->
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-default" type="button">
												 New Gown Hirings  <span class="badge"><?php echo $c ; ?></span>
											</button>
											</a>
                                        </h4>
                                    </div>
...
$con->close();
                      ...
                      <!-- End  Basic Table  --> 
								...
								<?php
/*
                                 $rsql = "SELECT * FROM gownbook";
$rre = $con->query($sql);
if ($rre->num_rows = 0) {
// output data of each row
while($row = $rre->fetch_assoc()) {
                               $br = $row['stat'];
                                        if($br=="Conform")
                                        {
                                            $r = $r + 1;
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-primary" type="button">
												 Booked Gowns  <span class="badge"></span>
											</button>
